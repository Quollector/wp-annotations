<div id="wp-annotations--discussions" class="wp-annotations--discussions">
    <div class="wp-annotations--discussions__wrapper">
        <div class="discussion-box">
            ...
            <div class="discussion-box__comment">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda natus amet, minus suscipit eos nulla. Repudiandae adipisci tempore doloribus modi! Quae aliquam maxime quia quos laboriosam saepe quis temporibus laborum?
            </div>
        </div>
    </div>
</div>